...
public class ExpenseMenager {
    List<Expense> expenses = new ArrayList<>();

    public void displayAllExpenses(){
        expenses.forEach(ExpenseMenager::displayExpenese);
    }


    private static void displayExpenese(Expense expense) {
        System.out.println(expense.descrpition());
    ...
    public void displayMonthlyExpenses(Scanner scanner){
        ...
        expenses.stream()
                ...
                .forEach(ExpenseMenager::displayExpenese);
    ...
    public void  addExpense(Scanner scanner){
        ...
        System.out.println("Z któego miesiąca to wydatek?");
        int month = Integer.parseInt(scanner.nextLine());
